...
<body>
	...
	<!-- FAQ Area Start -->
    <div class="faq__two faq__two-page section-padding">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 lg-mb-30">
                    <div class="faq__two-collapse mt-0">
                        <div class="faq__two-collapse-item">
                            <div class="faq__two-collapse-item-card">
                                <div class="faq__two-collapse-item-card-header">
                                    <h5>Which department do you work in?</h5>
                                    <i class="far fa-minus"></i>
                                </div>
                                <div class="faq__two-collapse-item-card-header-content active">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod it empor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni am, quis nostrud exercitation ullamco</p>
                                </div>
                            </div>
                        </div>
                        <div class="faq__two-collapse-item">
                            <div class="faq__two-collapse-item-card">
                                <div class="faq__two-collapse-item-card-header">
                                    <h5>What is one of your favorite quotes?</h5>
                        ...
                        <div class="faq__two-collapse-item">
                            <div class="faq__two-collapse-item-card">
                                <div class="faq__two-collapse-item-card-header">
                                    <h5>Our power of choice is untrammelled?</h5>
                                    <i class="far fa-plus"></i>
                                </div>
                                <div class="faq__two-collapse-item-card-header-content display-none">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod it empor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni am, quis nostrud exercitation ullamco</p>
				...
				<div class="col-xl-6 col-lg-6">
                    <div class="faq__two-collapse mt-0">
                        <div class="faq__two-collapse-item">
                            <div class="faq__two-collapse-item-card">
                                <div class="faq__two-collapse-item-card-header-two">
                                    <h5>Our power of choice is untrammelled?</h5>
                                    <i class="far fa-minus"></i>
                                </div>
                                <div class="faq__two-collapse-item-card-header-two-content display-none">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod it empor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni am, quis nostrud exercitation ullamco</p>
                                </div>
                            </div>
                        </div>
                        <div class="faq__two-collapse-item">
                            <div class="faq__two-collapse-item-card">
                                <div class="faq__two-collapse-item-card-header-two">
                                    <h5>Fully answer the question?</h5>
                                    <i class="far fa-plus"></i>
                                </div>
                                <div class="faq__two-collapse-item-card-header-two-content active">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod it empor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni am, quis nostrud exercitation ullamco</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="faq__area section-padding">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 lg-mb-30">
					<div class="faq__area-right faq__area-right-page">
						<div class="faq__area-right-title">
							<span class="subtitle-two">Answer</span>
							<span class="subtitle-one">FAQ</span>
							<h2>Get kind of answer</h2>							
						</div>
							...
							<div class="faq__area-collapse-item">
								<div class="faq__area-collapse-item-card">
									<div class="faq__area-collapse-item-card-header">
										<h5>How to make an website customizations?</h5>
										<i class="far fa-minus"></i>
									</div>
									<div class="faq__area-collapse-item-card-header-content active">
										<p>When our team provides design and digital marketing. Applied arts can include industrial design, graphic design, fashion design, and the decorative arts.</p>
									</div>
								</div>
							</div>
							<div class="faq__area-collapse-item">
					...
					<div class="faq__area-left">
						<div class="faq__area-left-image">
							...
							<div class="faq__area-left-image-two">
								<img src="assets/img/faq-2.jpg" alt="">
							</div>
