...
<head>
	...
	<meta name="description" content="Finaxio - HTML5 Template" />
...
<body>
							...
							<ul id="mobilemenu">
								...
								<li><a href="#">Pages<i class="far fa-angle-down"></i></a>
									<ul class="sub-menu">
										...
										<li><a href="case.html">Case</a>
										</li>
										<li><a href="case-details.html">Case Details</a>
										</li>
								...
								<li><a href="#">News<i class="far fa-angle-down"></i></a>
									<ul class="sub-menu">
										<li><a href="news-grid.html">News Grid</a>
										</li>
										<li><a href="news-standard.html">News Standard</a>
										</li>
										<li><a href="news-details.html">News Details</a>
										</li>
									</ul>
								</li>
						...
						<div class="header__area-menu-bar-right">
							<div class="header__area-menu-bar-right-item">
								<div class="header__area-menu-bar-right-item-search">
									<div class="search">	
										<span class="header__area-menu-bar-right-item-search-icon open"><i class="fal fa-search"></i></span>
									</div>
									<div class="header__area-menu-bar-right-item-search-box">
										...
										</form> <span class="header__area-menu-bar-right-item-search-box-icon"><i class="fal fa-times"></i></span>
									</div>
								</div>								
							</div>
							<div class="header__area-menu-bar-right-item">
							...
							<div class="header__area-menu-bar-right-item">
								<div class="header__area-menu-bar-right-item-login">
									<div class="search">	
										<span class="header__area-menu-bar-right-item-login-icon open"><i class="far fa-user"></i></span>
									</div>
										...
										<div class="header__area-menu-bar-right-item-login-area">
											<div class="header__area-menu-bar-right-item-login-area-bg">
												...
												<form action="#">											
													...
													<button class="theme-btn1" type="submit" name="button">Sign In</button>
													<input type="checkbox" checked="checked" name="remember"> Remember me											
												</form>
												<span class="header__area-menu-bar-right-item-login-box-icon"><i class="fal fa-times"></i></span>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="menu-box">
					...
					<div class="contact__info">
						...
						<div class="contact__info-list">
							...
							<a href="mailto:info@webmail.com"><i class="fal fa-envelope-open-text"></i>info@webmail.com</a>
	...
	<div class="page__banner" data-background="assets/img/page/page.jpg">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 lg-mb-30">
                    <div class="blog__details-left">
                        ...
                        <div class="row mt-30 mb-30">
                            <div class="col-sm-6 sm-mb-30">
                                <div class="blog__details-left-list blog__details-left-list-hover">
                                    <img class="img__full" src="assets/img/page/service-2.jpg" alt="">
                                    <div class="blog__details-left-list-video-icon video-pulse">	
                            ...
                            <div class="col-sm-6">
                                <div class="blog__details-left-list">
                                    <img class="img__full" src="assets/img/page/service-3.jpg" alt="">
                                    <div class="blog__details-left-list-video-icon video-pulse">	
                                        <a class="video-popup" href="https://www.youtube.com/watch?v=0WC-tD-njcA"><i class="fas fa-play"></i></a>
                                    </div>
                                </div>
                        ...
                        <h3 class="mb-20">Setting the mood with incense</h3>
                        ...
                        <p class="mb-35">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore</p>
                        ...
                        <div class="blog__details-left-post mb-40">
							<div class="blog__details-left-post-author">
								<div class="blog__details-left-post-author-image">
									<img src="assets/img/avtar/author.png" alt="">
								</div>
                        ...
                        <div class="blog__details-left-comment mb-40">
							<h4 class="mb-30">Comment 03</h4>
							<div class="blog__details-left-comment-item">
								<div class="blog__details-left-comment-item-comment">
									<div class="blog__details-left-comment-item-comment-image">
										<img src="assets/img/avtar/11.png" alt="">									
									</div>									
									<div class="blog__details-left-comment-item-comment-content">
                                        ...
                                        <p>For all the assets is hard and time-consuming technical work. And, of course, the result needs to be seamless and delightful — dare we say, even fun — to develop and maintain. Regardless of whether you’re ing up a storefront for a new merchant.</p>
									</div>
								</div>
							</div>
							<div class="blog__details-left-comment-item ml-80">
								<div class="blog__details-left-comment-item-comment">
									<div class="blog__details-left-comment-item-comment-image">
										<img src="assets/img/avtar/12.png" alt="">									
									</div>									
									<div class="blog__details-left-comment-item-comment-content">
							...
							<div class="blog__details-left-comment-item">
								<div class="blog__details-left-comment-item-comment">
									<div class="blog__details-left-comment-item-comment-image">
										<img src="assets/img/avtar/13.png" alt="">									
									</div>									
									<div class="blog__details-left-comment-item-comment-content">
										<h5>Shawn Mendes<a href="#"><i class="fal fa-reply"></i>Reply</a></h5>
										<span>26 May, 2022  At 6:AM</span>
                                        <p>For all the assets is hard and time-consuming technical work. And, of course, the result needs to be seamless and delightful — dare we say, even fun — to develop and maintain. Regardless of whether you’re ing up a storefront for a new merchant.</p>
									</div>
								</div>
							</div>
                        ...
                        <div class="blog__details-left-contact">
							<h4 class="mb-30">Post Comment</h4>
                            <div class="blog__details-left-contact-form">
                                <form action="#">	
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">										
                                            <div class="blog__details-left-contact-form-item">
                                                <button class="theme-btn3" type="submit" name="button">Post Comment</button>
                                            </div>										
                                        </div>
                                    </div>							
                                </form>	
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="all__sidebar mt-0">
                        ...
                        <div class="all__sidebar-item">
                            <h5>About Me</h5>
                            <div class="all__sidebar-item-about">
                                <img src="assets/img/about/blog.png" alt="">
                                <h6>Sakshma Srivastav</h6>
                                <p>Novia's spaciously two bedroom apartments are perfect for families and even business partners.</p>
                                <ul>
									<li><a href="#"><i class="fab fa-facebook-f"></i></a>
									</li>
									<li><a href="#"><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="all__sidebar-item-post">
                                <div class="all__sidebar-item-post-item">
                                    <div class="all__sidebar-item-post-item-image">
                                        <a href="news-details.html"><img src="assets/img/blog/post-7.jpg" alt=""></a>
                                    </div>
                                    <div class="all__sidebar-item-post-item-content">
                                        <h6><a href="news-details.html">Having education in an area helps</a></h6>
                                        <span><i class="fal fa-calendar-alt"></i>June 12, 2022</span>
                                    </div>
                                </div>
                                <div class="all__sidebar-item-post-item">
                                    <div class="all__sidebar-item-post-item-image">
                                        <a href="news-details.html"><img src="assets/img/blog/post-8.jpg" alt=""></a>
                                    </div>
                                    <div class="all__sidebar-item-post-item-content">
                                        <h6><a href="news-details.html">People think, feel, & behave in a way</a></h6>
                                        <span><i class="fal fa-calendar-alt"></i>June 09, 2022</span>
                                    </div>
                                </div>
                                <div class="all__sidebar-item-post-item">
                                    <div class="all__sidebar-item-post-item-image">
                                        <a href="news-details.html"><img src="assets/img/blog/post-9.jpg" alt=""></a>
                                    </div>
                                    <div class="all__sidebar-item-post-item-content">
                                        <h6><a href="news-details.html">That contributes to their success</a></h6>
                                        <span><i class="fal fa-calendar-alt"></i>June 09, 2022</span>
                                    </div>
                                </div>
                                <div class="all__sidebar-item-post-item">
                                    <div class="all__sidebar-item-post-item-image">
                                        <a href="news-details.html"><img src="assets/img/blog/post-10.jpg" alt=""></a>
                                    </div>
                                    <div class="all__sidebar-item-post-item-content">
                                        <h6><a href="news-details.html">Amazon walmart or genz motors zone fire</a></h6>
                                        <span><i class="fal fa-calendar-alt"></i>June 09, 2022</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="all__sidebar-item">
                            ...
                            <div class="all__sidebar-item-category">
                                <ul>                                    
                                    <li><a href="news-details.html">Business<span>26</span></a></li>
                                    <li><a href="news-details.html">Consultant<span>30</span></a></li>
                                    <li><a href="news-details.html">Creative<span>71</span></a></li>
                                    <li><a href="news-details.html">UI/UX<span>60</span></a></li>
                                    <li><a href="news-details.html">Technology<span>56</span></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="all__sidebar-item">
                            ...
                            <div class="all__sidebar-item-tag">
                                <ul>
                                    <li><a href="news-grid.html">Popular</a></li>
                                    <li><a href="news-grid.html">Design</a></li>
                                    <li><a href="news-grid.html">UI/UX</a></li>
                                    <li><a href="news-grid.html">Usability</a></li>
                                    <li><a href="news-grid.html">Develop</a></li>
                                    <li><a href="news-grid.html">Icon</a></li>
                                    <li><a href="news-grid.html">Business</a></li>
                                    <li><a href="news-grid.html">Consult</a></li>
                                    <li><a href="news-grid.html">Kit</a></li>
                                    <li><a href="news-grid.html">Keyboard</a></li>
                                    <li><a href="news-grid.html">Mouse</a></li>
                                    <li><a href="news-grid.html">Tech</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="all__sidebar-image">
                            <img class="img__full" src="assets/img/blog/blog-10.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
	...
	<!-- Footer Top End -->
	<!-- Footer Two Start -->
	<div class="footer__two-page" data-background="assets/img/bg/footer-bg-2.png">
		<div class="container">
			<div class="row">
				<div class="col-xl-2 col-lg-6 col-md-5 col-sm-5 xl-mb-30">
					<div class="footer__two-page-widget">
						...
						<div class="footer__two-page-widget-menu">
							<ul>
								<li><a href="about.html"><i class="far fa-angle-right"></i>Company</a></li>
								<li><a href="about.html"><i class="far fa-angle-right"></i>Careers</a></li>
								<li><a href="about.html"><i class="far fa-angle-right"></i>Press media</a></li>
								<li><a href="news-details.html"><i class="far fa-angle-right"></i>Our Blog</a></li>
								<li><a href="faq.html"><i class="far fa-angle-right"></i>Privacy Policy</a></li>
							...
							<div class="col-6">
								<div class="footer__two-page-widget-menu">
									<ul>
										...
										<li><a href="team.html"><i class="far fa-angle-right"></i>Team</a></li>
										<li><a href="#"><i class="far fa-angle-right"></i>Clients</a></li>
										<li><a href="#"><i class="far fa-angle-right"></i>Testimonials</a></li>
										<li><a href="contact.html"><i class="far fa-angle-right"></i>Get Quote</a></li>
										<li><a href="contact.html"><i class="far fa-angle-right"></i>Get In Touch</a></li>
									</ul>
								</div>
							</div>
							<div class="col-6">
								<div class="footer__two-page-widget-menu">
									<ul>
										<li><a href="contact.html"><i class="far fa-angle-right"></i>Support</a></li>
										<li><a href="news-grid.html"><i class="far fa-angle-right"></i>News</a></li>
						...
						<div class="footer__two-page-widget-post">
							<div class="footer__two-page-widget-post-item">
								<div class="footer__two-page-widget-post-item-image">
									<a href="case-details.html"><img src="assets/img/blog/post-3.jpg" alt=""></a>
								</div>
							...
							<div class="footer__two-page-widget-post-item">
								<div class="footer__two-page-widget-post-item-image">
									<a href="case-details.html"><img src="assets/img/blog/post-4.jpg" alt=""></a>
								</div>
								<div class="footer__two-page-widget-post-item-content">
									<span>June 09, 2022</span>
									<h6><a href="news-details.html">The most successful businesses</a></h6>
								</div>
							</div>
						</div>
					</div>					
			...
			<div class="row align-items-center">
				<div class="col-xl-7 col-lg-7">
					<div class="copyright__two-content">
						<p>Copyright & Design By <a href="https://themeforest.net/user/themeori/portfolio">@themeori</a> - 2022</p>
					</div>
				</div>
