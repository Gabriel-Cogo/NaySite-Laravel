            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="portfolio__details-top">
                        <div class="portfolio__details-top-list">
                            <div class="portfolio__details-top-list-left lg-mb-30">
                                <div class="portfolio__details-top-list-left-item">
                                    <h5>Client :</h5>
                                ...
                                <div class="portfolio__details-top-list-left-item">
                                    <h5>Category :</h5>
                                    <span>Consultancy, Business, UX</span>
                                </div>
                            </div>
                            <div class="portfolio__details-top-list-right">
                                <a href="#" class="theme-btn3">Live Preview <i class="far fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="portfolio__details-image mb-40">
                        <img class="img__full" src="assets/img/portfolio/portfolio-12.jpg" alt="">
                    </div>
                    <div class="portfolio__details-content">
                        <p class="mb-20">Our customized content solutions utilize key word density that we craft specifically for your needs. We take pride in writing original, effective and engaging content that sets apart in an Internet awash with thin, dull filler copy. We develop your feature articles, newsletters, white papers, social media messages harmoniously to generate top internet rankings in any market. We take pride in giving your blog, newsletter or website the professional polish it deserves and helping you build your brand. Our marketing team has more than three decades of industry experience developing and promoting content across broad spectrum of channels. Our integrated marketing strategies have a proven success record backed with industry-leading database management tools. When you choose Business Content, you gain access to some of the most informative analytics in the industry, making every campaign an investment in your future success,</p>
                        <p>We know you have a choice. We believe you'll choose Business Content for our knowledge and comprehensive marketing programs. We know you'll stay with us because of outstanding results and customer satisfaction we deliver. We're dedicated to staying ahead of the curve and being your value-added marketing partner. We know you have a choice. We believe you'll choose Business Content for our knowledge and comprehensive marketing programs. We know you'll stay with us because of the outstanding result customer satisfaction we deliver. We're dedicated to staying ahead of the curve and being your value-added marketing partner.</p>
                        <div class="portfolio__details-content-box">
                            <div class="row align-items-center">
                                <div class="col-lg-2 col-md-3 md-mb-30">
                                    <div class="portfolio__details-content-box-left">
                                        <img class="img__full" src="assets/img/avtar/14.png" alt="">
                                        <i class="fal fa-quote-left"></i>
                                    </div>
                                </div>
                                <div class="col-lg-10 col-md-9">
                                    <div class="portfolio__details-content-box-right">
                                        <h4>"Business Content provides fully integrated marketing services designed to reach your target audience through specialized content and effective creative"</h4>
                                        <h6>James Anderson<span>- Head Of Idea</span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-10">Project Challenges</h4>
                        <p class="mb-30">Still not convinced that gaming is good for you? Thats understandable, considering concerns long raised by parents that include the treatment of women social gaming,
                            violence in games and gaming addiction. For more information, explore the Safer Gaming Guide from the Family Online Safety Institute. The absolute best recommendation for
                            the parents worried about game safety or that your kid is gaming too much: Join your kids on their favorite platform.</p>
                        <div class="row">
                            <div class="col-sm-4 sm-mb-30">
                                <img class="img__full" src="assets/img/portfolio/portfolio-9.jpg" alt="">
                            </div>
                            <div class="col-sm-4 sm-mb-30">
                                <img class="img__full" src="assets/img/portfolio/portfolio-10.jpg" alt="">
                            </div>
                            <div class="col-sm-4">
                                <img class="img__full" src="assets/img/portfolio/portfolio-11.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="portfolio__details-bottom">
                        <div class="portfolio__details-bottom-item">
                            <h6><a href="#">Prev Case</a></h6>
                            <h4><a href="#">Tips On Minimalist</a></h4>                                                
                        </div>
                        <div class="portfolio__details-bottom-item active t-right">
                            <h6><a href="#">Next Case</a></h6>
