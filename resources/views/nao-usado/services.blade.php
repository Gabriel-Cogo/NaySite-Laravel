...
<body>
	...
	<!-- Services Area Start -->
	<div class="services__area-page section-padding">
		<div class="container">
			<div class="row">
				<div class="col-xl-4 col-lg-4 col-md-6 mb-30">
					<div class="services__area-item">
						...
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Strategic Consulting Services</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 md-mb-30">
					<div class="services__area-item">
						...
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Business Lineup Service</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 lg-mb-30">
					<div class="services__area-item">
						...
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Online & Offline Support</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 md-mb-30">
					<div class="services__area-item">
						<div class="services__area-item-icon">
							...
							<div class="services__area-item-icon-one">
								<img src="assets/img/icon/service-11.png" alt="">
							</div>
						</div>
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Business Consultancy Service</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6 md-mb-30">
					<div class="services__area-item">
						<div class="services__area-item-icon">
							...
							<div class="services__area-item-icon-one">
								<img src="assets/img/icon/service-22.png" alt="">
							</div>
						</div>
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Finance & Business Lineup</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-4 col-md-6">
					<div class="services__area-item">
						<div class="services__area-item-icon">
							...
							<div class="services__area-item-icon-one">
								<img src="assets/img/icon/service-33.png" alt="">
							</div>
						</div>
						<div class="services__area-item-content">
							<h3><a href="services-details.html">Business Security Solution</a></h3>
							<a class="simple-btn" href="services-details.html">Read More<i class="far fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
	...
	<!-- Services Area End -->
	<!-- Skill Area Start -->
    <div class="services__area-page-skill section-padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 lg-mb-30">
                    <div class="services__area-page-skill-left">
                        <div class="services__area-page-skill-left-title">
                            <span class="subtitle-two">Skills</span>
                            <span class="subtitle-one">Skillset</span>
                            <h2>Strategy is at the Heart of demand</h2>
                            <p>Our mission is to provide quality English language instruction a variety of courses to international and local students in a professional and supportive atmosphere.</p>	
                        </div>
                        <div class="services__area-page-skill-left-item-skill">
                            <div class="services__area-page-skill-left-item-skill-content">
                                <h5>Digital Strategy</h5>
                                <span class="services__area-page-skill-left-item-skill-count">
                                <span class="counter">68</span>%</span>
                            </div>
                            <div class="services__area-page-skill-left-item-skill-inner">
                                <div class="services__area-page-skill-left-item-skill-bar" data-width="68"></div>
                            </div>
                        </div>
                        <div class="services__area-page-skill-left-item-skill">
                            <div class="services__area-page-skill-left-item-skill-content">
                            ...
                            <div class="services__area-page-skill-left-item-skill-inner">
                                <div class="services__area-page-skill-left-item-skill-bar" data-width="80"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="services__area-page-skill-right">
                        <div class="services__area-page-skill-right-image">
                            <img src="assets/img/services.jpg" alt="">
							<div class="services__area-page-skill-right-image-video-icon">	
